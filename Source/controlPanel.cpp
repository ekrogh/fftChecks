	...
	: pFFTChecks(pFFTChks)
{
	...
	contButton->setBounds(72, 347, 95, 24);
	...
	_2i2_toggleButton->setBounds(0, 345, 59, 24);
	...
	defaultsTextButton->setBounds(244, 347, 95, 24);
	...
	signalToggleButton->setBounds(0, 224, 95, 24);
	...
	carrierToggleButton->setBounds(102, 224, 95, 24);
	...
	FFTToggleButton->setBounds(0, 307, 95, 24);
	...
	modulatedSignalToggleButton->setBounds(203, 224, 95, 24);

	inSamePlotToggleButton.reset(new juce::ToggleButton("inSamePlotToggleButton"));
	addAndMakeVisible(inSamePlotToggleButton.get());
	inSamePlotToggleButton->setButtonText(TRANS("in same plot"));
	inSamePlotToggleButton->addListener(this);

	inSamePlotToggleButton->setBounds(80, 264, 111, 24);
	...
	pFFTChecks->set_show_signal_plot(signalToggleButton->getToggleState());
	pFFTChecks->set_show_carrier_plot(carrierToggleButton->getToggleState());
	pFFTChecks->set_show_modulated_plot(modulatedSignalToggleButton->getToggleState());
	pFFTChecks->set_show_inSame_plot(inSamePlotToggleButton->getToggleState());
	pFFTChecks->set_show_FFT_plot(FFTToggleButton->getToggleState());
...
controlPanel::~controlPanel()
{
	...
	inSamePlotToggleButton = nullptr;
...
void controlPanel::buttonClicked(juce::Button* buttonThatWasClicked)
{
	...
	else if (buttonThatWasClicked == inSamePlotToggleButton.get())
	{
		//[UserButtonCode_inSamePlotToggleButton] -- add your button handler code here..
		pFFTChecks->set_show_inSame_plot(inSamePlotToggleButton->getToggleState());
		//[/UserButtonCode_inSamePlotToggleButton]
	}
...
void controlPanel::displayAll()
{
	...
	signalToggleButton->setToggleState(pFFTChecks->get_show_signal_plot(), false);
	carrierToggleButton->setToggleState(pFFTChecks->get_show_carrier_plot(), false);
	modulatedSignalToggleButton->setToggleState(pFFTChecks->get_show_modulated_plot(), false);
	inSamePlotToggleButton->setToggleState(pFFTChecks->get_show_inSame_plot(), false);
	FFTToggleButton->setToggleState(pFFTChecks->get_show_FFT_plot(), false);
...
<JUCER_COMPONENT documentType="Component" className="controlPanel" componentName=""
  ...
  <TEXTBUTTON name="contButton" id="6bbdd155c2eb5000" memberName="contButton"
			  virtualName="" explicitFocusOrder="7" pos="72 347 95 24" buttonText="Continue"
			  connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TOGGLEBUTTON name="2i2_toggleButton" id="686966a11665c450" memberName="_2i2_toggleButton"
				virtualName="" explicitFocusOrder="0" pos="0 345 59 24" buttonText="2 i 1"
				connectedEdges="0" needsCallback="1" radioGroupId="0" state="1"/>
  <TEXTBUTTON name="defaultsTextButton" id="e1fa1deda629935b" memberName="defaultsTextButton"
			  virtualName="" explicitFocusOrder="0" pos="244 347 95 24" buttonText="Defaults"
			  connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  ...
  <TOGGLEBUTTON name="signalToggleButton" id="f73ed889b5ae397a" memberName="signalToggleButton"
				virtualName="" explicitFocusOrder="0" pos="0 224 95 24" buttonText="signal"
				connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="carrierToggleButton" id="dd6929ff2fce5ba7" memberName="carrierToggleButton"
				virtualName="" explicitFocusOrder="0" pos="102 224 95 24" buttonText="carrier"
				connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="FFTToggleButton" id="760272dd03666e9f" memberName="FFTToggleButton"
				virtualName="" explicitFocusOrder="0" pos="0 307 95 24" buttonText="FFT"
				connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="modulatedSignalToggleButton" id="beecf6c5a9ba75f5" memberName="modulatedSignalToggleButton"
				virtualName="" explicitFocusOrder="0" pos="203 224 95 24" buttonText="modulated"
				connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <TOGGLEBUTTON name="inSamePlotToggleButton" id="91bf253e49e5ea30" memberName="inSamePlotToggleButton"
				virtualName="" explicitFocusOrder="0" pos="80 264 111 24" buttonText="in same plot"
				connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
</JUCER_COMPONENT>
