	...
	: pFFTChecks(pFFTChks)
{
	...
	FFTInCombinedPlotToggleButton->setBounds(77, 345, 32, 24);
	...
	FFTInCombinedPlotToggleButton->setVisible(false);
	FFTInCombinedPlotToggleButton->setEnabled(false);
	FFTInCombinedPlotToggleButton->setToggleState(false, juce::NotificationType::dontSendNotification);
	FFTInCombinedPlotToggleButton->setClickingTogglesState(false);
	FFTInCombinedPlotToggleButton->setToggleable(false);
...
<JUCER_COMPONENT documentType="Component" className="controlPanel" componentName=""
  ...
  <TOGGLEBUTTON name="FFTInCombinedPlotToggleButton" id="b87871719e0459d2" memberName="FFTInCombinedPlotToggleButton"
				virtualName="" explicitFocusOrder="0" pos="77 345 32 24" tooltip="FFT in combined plot"
				buttonText="" connectedEdges="0" needsCallback="1" radioGroupId="0"
				state="0"/>
